...
APP_ROOT = path(__file__).abspath().dirname().dirname()  # /blah/blah/blah/.../openedx_plugin_waffle/openedx_plugin
REPO_ROOT = APP_ROOT.dirname()  # /blah/blah/blah/.../openedx_plugin_waffle
